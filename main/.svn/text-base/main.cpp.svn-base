...
int main( int argc, const char** argv )
{
  ...
  switch (no)
    ...
    case 1: 
      {
      cout << "\nThe minimum beam spacing for 256 x 256 image is 0.0077 (with maximum 363 X-ray beams)\n";
    ...
    case 2: 
      {
	cout << "\nThe minimum beam spacing for 200x200 image is 0.01 (with maximum 283 X-ray beams)\n";
    ...
    case 3: 
      {
	cout << "\nThe minimum beam spacing for 100x100 image is 0.02 (with maximum 143 X-ray beams)\n";
  ...
  cout << "\n Any value smaller than the above minimum spacing will be treated as minimum. Please input your beam spacing: ";
  double d;
  cin>> d;
